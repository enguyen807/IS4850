...
var dbRefObject = firebase.database('https://blueoceanrestaurant-f8f59.firebaseio.com/');

var preObject = document.getElementById('Cunty');

dbRefObject.ref().child('Cunty');
